...
public interface DriveTurdSpecific {
    ...
    //OFFSET IS SUBTRACTED NOT ADDED
    double FRONT_LEFT_OFFSET_TURD = Math.toRadians(78.404289); // set front left steer offset
    double FRONT_RIGHT_OFFSET_TURD = Math.toRadians(105.35707037500001); // set front right steer offset
    double BACK_LEFT_OFFSET_TURD = Math.toRadians(12.6972654); // set back left steer offset
    double BACK_RIGHT_OFFSET_TURD = Math.toRadians(128.56785885000002); // set back right steer offset
