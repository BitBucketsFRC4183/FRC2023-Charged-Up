...
//public class DoubleJointedArmSim extends TimedRobot {
...
//
//    private final SingleJointedArmSim lowerArm;
//    private final SingleJointedArmSim upperArm;
//
//    public DoubleJointedArmSim (SingleJointedArmSim lowerArm, SingleJointedArmSim upperArm)
//    {
...
//                            "Arm Top",
//                            28.5 + 3.0,
//                            Units.radiansToDegrees(lowerArm.getAngleRads()),
//                            10,
...
//                            "Intake",
//                            7,
//                            Units.radiansToDegrees(upperArm.getAngleRads()),
//                            40,
...
//        lowerArm.setInput(m_topMotor.get() * RobotController.getBatteryVoltage());
//        lowerArm.setInput(m_bottomMotor.get() * RobotController.getBatteryVoltage());
//
//        // Next, we update it. The standard loop time is 20ms.
//        lowerArm.update(0.020);
//        lowerArm.update(0.020);
//
//        // Finally, we set our simulated encoder's readings and simulated battery voltage
//        m_topEncoderSim.setDistance(lowerArm.getAngleRads());
//        m_bottomEncoderSim.setDistance(lowerArm.getAngleRads());
//        // SimBattery estimates loaded battery voltages
//        RoboRioSim.setVInVoltage(
//                BatterySim.calculateDefaultBatteryLoadedVoltage(lowerArm.getCurrentDrawAmps() + lowerArm.getCurrentDrawAmps()));
//
//        // Update the Mechanism Arm angle based on the simulated arm angle
//        m_arm_top.setAngle(Units.radiansToDegrees(upperArm.getAngleRads()));
//        m_arm_bottom.setAngle(Units.radiansToDegrees(lowerArm.getAngleRads()));
//    }
//
//    @Override
