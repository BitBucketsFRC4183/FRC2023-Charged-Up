...
public class InverseKinematics {
    ...
    public double getLowerJointAngle() {
        ...
        double lowerJointAngle = Math.acos((Math.pow(ArmConstants.LOWER_JOINT_LENGTH, 2) + Math.pow(c, 2) - Math.pow(ArmConstants.UPPER_JOINT_LENGTH, 2)) / (2 * ArmConstants.LOWER_JOINT_LENGTH * c)) - alpha;
