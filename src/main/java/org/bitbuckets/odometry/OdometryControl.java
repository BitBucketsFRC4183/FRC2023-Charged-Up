...
public class OdometryControl {
    ...
    public OdometryControl(DriveControl driveControl, DriveControlSDS driveControlSDS, Pose2d pose2d) {
        this.driveControl = driveControl;
        this.driveControlSDS = driveControlSDS;
        this.swerveDriveOdometry = new SwerveDriveOdometry(RobotConstants.KINEMATICS, gyroangle, driveControl.reportActualPositions(), pose2d);
        this.swerveDrivePoseEstimator = new SwerveDrivePoseEstimator(RobotConstants.KINEMATICS, gyroangle, driveControl.reportActualPositions(), pose2d);
    ...
    public void estimatedSwervePose() {
        swerveDrivePoseEstimator.update(gyroangle, driveControl.reportActualPositions());
