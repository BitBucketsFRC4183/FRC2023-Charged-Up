...
class ArmControlTest {
    ...
    void convertMechanismRotationToRawRotation_lowerJoint() {
        ArmControl control = new ArmControl(Mockito.mock(), Mockito.mock(), Mockito.mock(), Mockito.mock());
    ...
    void test() {
        ...
        ArmControl control = new ArmControl(lowerJointSpy, Mockito.mock(), Mockito.mock(), Mockito.mock());
